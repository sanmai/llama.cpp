...
#pragma unroll
    ...
    // apply the optional per-tensor scale (NVFP4 weight_scale_2) to this block's partial sum;
    // it distributes over the stream-k summation, so write_back / fixup need no changes.
    if (scale != 1.0f) {
#pragma unroll
